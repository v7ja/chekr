...
if (!file_exists("infojjjjj.json")){
$infojjjjj = [];
}else{
$infojjjjj = json_decode(file_get_contents('infojjjjj.json'),true);
}
require("conf.php");
...
$infojjjjj["j"][] = file_get_contents("TheN").'.madeline';
file_put_contents('infojjjjj.json', json_encode($infojjjjj));
unlink("step");
unlink("TheN");
exit;
}
